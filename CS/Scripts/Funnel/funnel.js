var FunnelD3ItemExtension = (function() {
    ...
    function FunnelD3ItemViewer(dashboardControl, model, $container, options) {
        ...
        this.clearSelection = function () {
            Object.getPrototypeOf(this).clearSelection.call(this);
            this._update(this._getDataSource());
        };
        this.allowExportSingleItem = function () {
            return true;
        };
        this.getExportInfo = function () {
            return {
        ...
        this._ensureFunnelLibrary = function (element) {
            if (!window['D3Funnel']) {
                while(element.firstChild)
                    element.removeChild(element.firstChild);
        ...
        this._ensureFunnelSettings = function () {
            var _this = this;
        ...
        this._subscribeProperties = function () {
            var _this = this;
        ...
        this._update = function (data, options) {
        ...
        this._mergeOptions = function(options, newOptions) {
            var _this = this;
        ...
        this._updateExportingImage = function () {
        ...
        this._hasArguments = function () {
            return this.getBindingValue('Arguments').length > 0;
        };
        this._getImageBase64 = function () {
